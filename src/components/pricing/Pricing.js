    ...
    return (
        <div className="mx-auto container grid md:grid-cols-2 xs:min-h-auto text-brand gap-5">
            ...
            {/* <div className="w-full h-full flex justify-between items-center flex-col shadow bg-white rounded-xl md:p-10 xs:p-7 md:mt-0 xs:mt-2">
                ...
                <a href="https://mpago.li/17UZRJw" target="blank" className="w-full text-center border-2 border-brand bg-brand font-medium text-white hover:border-brand hover:bg-brand transition text-2xl py-2 mt-14 mb-5 rounded-xl">Comienza</a>
            </div> */}
        </div>
    )
}
