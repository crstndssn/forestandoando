        ...
        return (
            <div className="container mx-auto min-h-20 w-full  mt-20 mb-10">
                <div className="flex justify-center items-center xs:flex-col md:flex-row" >
                    <a target="_blank" href="https://www.instagram.com/forestandoando/" className="flex justify-center items-center text-brand md:text-3xl xs:text-2xl mb-7">
                        <img src={Instagram} alt="instagram" className="md:w-7 xs:w-6 text-brand mx-2" />
                        Instagram
                    </a>
                </div>
