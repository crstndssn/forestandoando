            ...
            <div className="container mx-auto min-h-70 flex justify-center items-center">
                <div className="flex justify-center items-center">
                    <div className="container mx-auto flex justify-center items-center flex-col">
                        ...
                        <div className="lg:w-2/3 md:w-2/3 xs:w-full flex justify-center items-center flex-col">
                            <button onClick={loginGoogle} className="bg-organic w-full flex justify-center items-center font-serif text-2xl border border-gray-200 shadow hover:shadow-lg transition duration-100 rounded-xl p-3 my-5 mb-3 focus:outline-none">
                                <img className="w-6 mx-2" src={google} alt="google" />Google</button>
                        </div>
                        <p className="transition duration-300 font-xl flex justify-center w-full my-5 text-gray-500">No tienes una cuenta?  <Link className="underline ml-2" to="/signup">Registrate</Link></p>
