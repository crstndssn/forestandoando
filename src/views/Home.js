...
import Posts from '../components/contenido/Posts';
            ...
            <div>
                ...
                <div className="bg-brand md:pt-10 xs:py-20">
                    <div className="container mx-auto flex justify-start items-start flex-col">
                        <h1 className="md:text-5xl text-4xl font-semibold mt-10 text-white">Contenido</h1>
                    </div>
                    <div className="flex justify-center items-center">
                        <Posts />
                    </div>
                    <div className="w-full flex justify-center items-center mt-5">
                        <Link className="text-white hover:text-brand bg-transparent hover:bg-white border border-white py-1 px-4 text-2xl rounded-full text-medium transition duration-200" to="/contenido">Ver más</Link>
                    </div>
                </div>
                <div className="mt-6">
                    <div className="container mx-auto flex justify-start items-start flex-col">
